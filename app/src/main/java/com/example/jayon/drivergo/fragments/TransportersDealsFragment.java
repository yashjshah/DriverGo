...
import com.example.jayon.drivergo.adapters.DealsTransporterAdapter;
...
public class TransportersDealsFragment extends Fragment {

    DealsTransporterAdapter offerRecyclerViewAdapter;
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        offerRecyclerViewAdapter=new DealsTransporterAdapter(getActivity(),list);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot data: dataSnapshot.getChildren()) {
                    ...
                    if (model.getTransporter().equals(currentUser.getUid()) && model.getStatus().equals("true")){
