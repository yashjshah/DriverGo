...
public class OfferSubscriptionTransporterAdapter extends RecyclerView.Adapter<OfferSubscriptionTransporterAdapter.myholder> {
    ...
    public OfferSubscriptionTransporterAdapter(Context context, List<SubscribeModel> list ){
